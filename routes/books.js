...
const booksLogger = winston.loggers.get('books');

// display books page
router.get('/', function(req, res, next) {

    booksLogger.debug('test log debug');
    booksLogger.error('test log error');
...
router.get('/edit/(:id)', function(req, res, next) {
    ...
    booksLogger.info('fin api /edit', id);
})
...
router.post('/update/:id', function(req, res, next) {
    ...
    booksLogger.info('fin api /UPDATE', id);
})
...
router.get('/delete/(:id)', function(req, res, next) {
    ...
    booksLogger.info('fin api /delete', id);
})
